...
ActiveRecord::Schema.define(version: 20121107162802) do
  ...
  create_table "categorizations", id: :integer, force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8" do |t|
    t.integer "tweet_id"
  ...
  create_table "tools_users", id: false, force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8" do |t|
    t.integer "Tool_id"
    t.integer "User_id"
  end

  create_table "tweets", id: :integer, force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8" do |t|
    t.string "message"
    t.integer "User_id"
    t.datetime "created_at"
    t.datetime "updated_at"
    ...
    t.index ["location_id"], name: "index_tweets_on_location_id"
  end
